...
const Header = ({ ...props }) => {
  ...
  return (
    <>
      {/* Header */}
      <div
        className={`fixed w-full z-40 px-6 lg:px-10 xl:px-20 py-4 lg:py-8 bg-secondary/80 backdrop-blur-sm lg:backdrop-blur-none lg:bg-transparent border-b border-white/10 lg:border-none ${
      ...
      >
        <div className="flex justify-between items-center">
          ...
          {!props.close ? (
            <button
              className={`lg:bg-[#1b2934] p-4 rounded-full text-white opacity-100 nav-icon btn-scale ${
                props.headerStatus && "opacity-100"
            ...
            >
              <button
                className={`bg-[#1b2934] p-4 rounded-full text-white opacity-100 nav-icon btn-scale ${
                  props.headerStatus && "opacity-100"
                } duration-300 ease-in-out`}
              >
                <svg
