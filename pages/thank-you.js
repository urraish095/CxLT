          ...
          height="0" width="0" style={{ display: 'none', visibility: 'hidden' }} />
            ...
            <div class="fixed w-full z-40 px-6 lg:px-10 xl:px-20 py-4 lg:py-8 bg-secondary/80 backdrop-blur-sm lg:backdrop-blur-none lg:bg-transparent border-b border-white/10 lg:border-none undefined">
                <div class="flex justify-between items-center">
                    ...
                    <Link class="lg:bg-[#1b2934] p-4 rounded-full text-white opacity-100 nav-icon btn-scale false duration-300 ease-in-out"
                        href="/"
                    >
                        <a>
                ...
                <div className="w-full lg:h-screen grid lg:grid-rows-6 bg-pink  p-10 lg:pt-24 xl:pt-32 2xl:pt-80 lg:pb-14 2xl:pb-0 lg:pl-32 xl:pl-48 2xl:pl-60 lg:pr-20 2xl:pr-28 overflow-hidden">
                    <div className="tetx-center">
                        ...
                        <div className="text-center">
                            <Link href='/'>
                                <a class="uppercase font-primary text-primary border-white px-6 py-2.5 "
                                    style={{
                                        "opacity": "1",
                                        "width": "auto",
                                    }}>
